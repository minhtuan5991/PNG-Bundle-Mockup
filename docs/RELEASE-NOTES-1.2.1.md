...
| GitHub Actions | Windows CI run [`31125907971`](https://github.com/minhtuan5991/PNG-Bundle-Mockup/actions/runs/31125907971) kết thúc `failure` vì job bị `cancelled` sau khoảng 15 phút mà chưa được cấp runner; không có step nào chạy. Workflow phát hành theo tag được giao trễ thành run [`31126661713`](https://github.com/minhtuan5991/PNG-Bundle-Mockup/actions/runs/31126661713) nhưng vẫn queued, chưa có runner; API cancel/force-cancel trả lỗi 500/502 trong outage. Workflow được thiết kế fail-closed trước Release public nên không thể ghi đè ba asset đã phát hành. |
