...
| v1.4.12 gender regions local QA | Codex local QA | 2026-09-01 | 169/169 test; source/package smoke 25/25; schema v1/v2 migration, gender-first matching, mockup đơn không bị ảnh hưởng, ASAR/version/updater metadata/Input/Print Area allowlist đạt. NSIS local 104378390 byte, SHA-256 `3a757994…cd1dd3`; Authenticode NotSigned. GitHub tag/release và cài tương tác còn chờ. |
