...
| v1.4.9 Print Area local QA | Codex local QA | 2026-08-30 | 159/159 test; packaged smoke 23/23; headless migration AppData → Print Area → snapshot exit 0 và SHA-256 khớp; ASAR/version/payload/checksum/updater metadata đạt. Chưa cài/nâng cấp tương tác; trạng thái GitHub được bổ sung sau workflow. |
