...
- Mã nguồn hiện tại chuẩn bị bộ cài `v1.4.6`. Sau lần phát hành này, dùng patch version mới từ `v1.4.7`; dùng đúng tag theo version trong `package.json`, không tái sử dụng tag cũ.
