...
- `v1.2.3` đã là Release public và không được ghi đè asset hoặc di chuyển tag.
- Bản chứa thay đổi sau v1.2.3 phải dùng `1.2.4` hoặc cao hơn.
...
1. Tạo `docs/RELEASE-NOTES-1.2.4.md` và ghi rõ thay đổi, kết quả QA cùng giới hạn còn lại.
...
git add -- docs/RELEASE-NOTES-1.2.4.md docs/PROJECT-HISTORY.md docs/REGRESSION-CHECKLIST.md
git status --short
```
