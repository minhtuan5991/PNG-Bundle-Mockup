...
Sau khi cài, dùng nút **Mở Input** để xác nhận thư mục `Input` nằm cạnh EXE và thêm PDF/ảnh mẫu của bạn. Bản stable hiện tại là [`v1.2.1`](https://github.com/minhtuan5991/PNG-Bundle-Mockup/releases/tag/v1.2.1), có đủ installer, blockmap và `latest.yml`. Bản installer `1.2.0` đã được xác minh nhận đúng thông báo `1.2.1`; người dùng vẫn chủ động bấm tải và cài đặt.
