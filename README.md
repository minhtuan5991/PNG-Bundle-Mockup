...
Sau khi cài, dùng nút **Mở Input** để xác nhận thư mục `Input` nằm cạnh EXE và thêm PDF/ảnh mẫu của bạn. Mã nguồn và bản stable public mới nhất hiện là [`v1.4.4`](https://github.com/minhtuan5991/PNG-Bundle-Mockup/releases/tag/v1.4.4).
...
Quy trình phát hành phiên bản tiếp theo (từ `v1.4.5`) được ghi trong [hướng dẫn cập nhật thủ công](docs/MANUAL-GITHUB-UPDATE.md). Không di chuyển tag hoặc ghi đè asset v1.4.4.
